...
# # 4) Combine all retrieved chunks using RRF
# # 5) Provide ranked chunks to LLM as a context
...
Assistant: {{ "step": "retrieved_chunks", "chunks": ["chunk1", "chunk2"] }}  
    ...
    while True: 
        ...
        while True:
            ...
            if step == "generated_queries":
                ...
                retrieved_chunks = await reciprocal_rank_fusion(generated_queries, max_chunks, embedding, collection_name)
